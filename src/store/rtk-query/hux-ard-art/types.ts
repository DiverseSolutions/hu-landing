...
export interface ArdArtPromoResult {
    id: number;
    code: string;
    discountPercentage: number;
    isActive: boolean;
...
export interface ArdArtCheckPromoResult {
    id: number;
    code: string;
    discountPercentage: number;
    isActive: boolean;
...
export interface ArdArtCheckCouponResult {
    count: number;
    bundles: ArdArtCheckCouponBundle[];
    products: ArdArtCheckCouponProduct[];
}

// Generated by https://quicktype.io

export interface ArdArtCheckCouponBundle {
    id: number;
    name: string;
    description: string;
    price: number;
...
export interface ArdArtCheckCouponProduct {
    id: number;
    createdAt: string;
    updatedAt: string;
    isActive: boolean;
...
export interface ArdArtPaypalInvoiceResult {
    invoiceId: number;
    response: {
        id: string;
        intent: string;
...
export interface ArdArtHelperLiveResult {
    cookie: {
        Name: string;
        Value: string;
        Path: string;
