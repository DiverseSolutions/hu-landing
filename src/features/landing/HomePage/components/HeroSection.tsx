            ...
            <div className="flex items-center justify-center w-full h-full">
                <div className="container">
                    <div className="flex flex-col items-center w-full h-full md:flex-row md:justify-center">
                        <div className="flex">
                            <img src={HomeSection2DragonImg.src} className={classNames(`object-contain transform h-[33vh] w-auto md:max-w-[326px] md:h-auto`,
                        ...
                        <div className="flex flex-col px-8 mt-8 md:mt-0 md:ml-64 md:px-0">
                            ...
                            <div className="mt-8">
                                <div className="max-w-[500px]">
                                    <p className="text-white break-all text-opacity-[0.65] text-sm md:text-[20px] text-justify">
